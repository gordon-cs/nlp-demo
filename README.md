**Note**  This repositiory contains files taken directly from https://github.com/adashofdata/nlp-in-python-tutorial by Alice Zhao.  The notebooks have been modified to use books from the New Testament (NET version) rather than comedian transcripts.
